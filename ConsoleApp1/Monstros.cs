...
namespace CRPG
{
    public class Monstros
    {
        ...
        private Monstros MonstroPlanice(int chance)
        {
            ...
            return new Monstros
            {
                monstroNome = monstroPlaniceNome[monstroIndex],
        ...
        private Monstros FlorestaMonstro(int chance)
        {
            ...
            return new Monstros
            {
                monstroNome = monstroFlorestaNome[monstroIndex],
        ...
        private Monstros PantanoMonstro(int chance)
        {
            ...
            return new Monstros
            {
                monstroNome = monstroPantanoNome[monstroIndex],
        ...
        private Monstros DesertoMonstro(int chance)
        {
            ...
            return new Monstros
            {
                monstroNome = monstroDesertoName[monstroIndex],
        ...
        private Monstros PiramideMosntro(int chance)
        {
            ...
            return new Monstros
            {
                monstroNome = monstroPiramideName[monstroIndex],
